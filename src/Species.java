...
public class Species {
	//The organism from the prev generation that we use to judge roughly what an organism from the  species looks like
	Organism prevMember;
	...
	//Previous fitness, used to make sure the species is progressing
	...
	//Combines 2 genomes, using the algorithm described in the paper
	...
	//Activates every organism in the species
	...
	//This is reproduction in the species
	//This includes both sexual reproduction(Combines genomes)
	//And asexual reproduction(Changes the weights)
	...
	//Gets the total combined fitness
	...
	//Finds the distance of a specific genome to the species, using algorithm from Neat
